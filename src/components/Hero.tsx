...
export default function Hero() {
  return (
    <section className="relative flex flex-col items-center justify-center overflow-hidden px-4 text-center">
      ...
      >
        {/* Sanskrit Text */}
        <div className="absolute left-2 top-2 font-serif text-[8px] text-gold/60 md:text-[10px]">
          || श्रीहित हरिवंश चंद्रो जयति ||
        </div>
        <div className="absolute right-2 top-2 font-serif text-[8px] text-gold/60 md:text-[10px]">
          || श्री राधा वल्लभो जयति ||
        </div>
