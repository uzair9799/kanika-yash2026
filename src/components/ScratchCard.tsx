...
export default function ScratchCard() {
  ...
  useEffect(() => {
    ...
    // Fill with cover color (Silver/Gold gradient)
    const gradient = ctx.createLinearGradient(0, 0, canvas.width, canvas.height);
    gradient.addColorStop(0, '#C0C0C0');
    gradient.addColorStop(0.25, '#E0E0E0');
    gradient.addColorStop(0.5, '#C0C0C0');
    gradient.addColorStop(0.75, '#E0E0E0');
      ...
      >
        ...
        <div className="scratch-container overflow-hidden rounded-lg shadow-2xl ring-1 ring-gold/30">
          ...
          <div className="flex h-full w-full flex-col items-center justify-center bg-cream p-4 text-center">
            <p className="font-serif text-xs uppercase tracking-widest text-maroon/60">Wedding Date</p>
            <p className="font-serif text-3xl font-bold text-maroon">20 April 2026</p>
